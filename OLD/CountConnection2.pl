...
while (1) {
	...
	$timestamp_old = $timestamp;
		...
		#Actual format is:
		# sometime however the line looks like a inbound traffic and we get this instead ... 
		# So rearrange so that we ca log  trafic inbound for that server. 
		...
		#tcp      6 89 TIME_WAIT src=66.249.74.8 dst=192.168.1.200 sport=64884 dport=80 packets=16 bytes=1293 src=192.168.2.30 dst=66.249.74.8 sport=80 dport=64884 packets=14 bytes=15385 [ASSURED] mark=0 use=2
